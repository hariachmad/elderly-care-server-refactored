INTENT_TO_NODE = {
    # Medicine
    "medicine schedule today": "medicine_schedule_today",
    ...
    # Doctor Appointment
    "doctor appointment schedule today": "doctor_appointment_schedule_today",
    ...
    # Visit Except Doctor
    "visit except doctor schedule today": "visits_today",
    ...
    "Increase Screen's Brightness" : "increase_screen_brightness",
    "Reduce Screen's Brightness" : "reduce_screen_brightness",
